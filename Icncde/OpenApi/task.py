...
from Icncde.OpenApi.spot_api import IccOpenApi
...
if __name__ == '__main__':
    # 账户信息 testerhome@qq.com   1045125549252915200
    ...
    BusinessProcess(ic_host, ic_api_key, ic_secret_key, ic_passphrase).taker_order_with_buy("DSSJ_USDT_ICNCDE_ENCRY")
